...
from . import serializers_list, serializers_detail
from .filters import *
...
def game_medal(request, pk):
    ...
    medals_serializer = serializers_list.MedalSerializer(medals, many=True)
...
def game_events(request, pk):
    ...
    game_serializer = serializers_list.GameSerializer(game)
...
def game_event_detail(request, gameid, eventid):
    ...
    medals_serializer = serializers_detail.MedalPeopleSerializer(medals, many=True)
